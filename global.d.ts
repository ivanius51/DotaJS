...
interface CScriptBindingPR_Players{
     ...
     */
    IsLocalPlayerInPerspectiveCamera(): number
    /**
...
interface CScriptBindingPR_Abilities{
    ...
    /**
     * 16 - not learned, 15 - still cooldown, 
     */
...
interface CScriptBindingPR_Game{
     ...
     * 
     */
    CreateCustomKeyBind( pszKey : string, pszCommand: string )
    /**
     * 
     */
     ...
     * 
     */
    SetDotaRefractHeroes( bEnabled:boolean )
    /**
     * 
     */
    FinishGame()
